...
%
  ...
  % Get the FA times in trial using the RT and (unreached) preStimMS, checking that there is only one RT per trial.
  ...
  % FA rate is taken from FA trials, together with the preStim time on Hit and Miss trials, which was available 
  % for FAs.  We clip out the early trial time that was not available for Hits or Misses
