function aggregate
    ...
    dataFiles = {   '/Users/Shared/Data/OKernel/902/MatFiles/2019-09-13.mat',...
                    '/Users/Shared/Data/OKernel/902/MatFiles/2019-09-16.mat',...
                    '/Users/Shared/Data/OKernel/902/MatFiles/2019-09-17.mat',...
                    '/Users/Shared/Data/OKernel/902/MatFiles/2019-09-18.mat',...
                    '/Users/Shared/Data/OKernel/902/MatFiles/2019-09-24.mat',...
                    '/Users/Shared/Data/OKernel/902/MatFiles/2019-09-25.mat',...
                    '/Users/Shared/Data/OKernel/902/MatFiles/2019-09-27.mat',...
                    '/Users/Shared/Data/OKernel/902/MatFiles/2019-09-29.mat'...
                    '/Users/Shared/Data/OKernel/902/MatFiles/2019-10-01.mat'...
                    '/Users/Shared/Data/OKernel/902/MatFiles/2019-10-02.mat'...
                    '/Users/Shared/Data/OKernel/902/MatFiles/2019-10-04.mat'...
                    '/Users/Shared/Data/OKernel/902/MatFiles/2019-10-07.mat'...
                    '/Users/Shared/Data/OKernel/902/MatFiles/2019-10-08.mat'...
                    '/Users/Shared/Data/OKernel/902/MatFiles/2019-10-09.mat'...
                    '/Users/Shared/Data/OKernel/902/MatFiles/2019-10-10.mat'...
                    '/Users/Shared/Data/OKernel/902/MatFiles/2019-10-11.mat'...
                    '/Users/Shared/Data/OKernel/902/MatFiles/2019-10-12.mat'...
                    '/Users/Shared/Data/OKernel/902/MatFiles/2019-10-14.mat'...
                    '/Users/Shared/Data/OKernel/902/MatFiles/2019-10-15.mat'...
                    '/Users/Shared/Data/OKernel/902/MatFiles/2019-10-16.mat'...
                    '/Users/Shared/Data/OKernel/902/MatFiles/2019-10-24.mat'...
                    '/Users/Shared/Data/OKernel/902/MatFiles/2019-11-05.mat'...
                    '/Users/Shared/Data/OKernel/902/MatFiles/2019-11-06.mat'...
                    '/Users/Shared/Data/OKernel/902/MatFiles/2019-11-07.mat'...
                    '/Users/Shared/Data/OKernel/902/MatFiles/2019-11-08.mat'...
                    '/Users/Shared/Data/OKernel/902/MatFiles/2019-11-09.mat'...
                    '/Users/Shared/Data/OKernel/902/MatFiles/2019-11-11.mat'...
                    '/Users/Shared/Data/OKernel/902/MatFiles/2019-11-12.mat'...
                    '/Users/Shared/Data/OKernel/902/MatFiles/2019-11-13.mat'...
                    '/Users/Shared/Data/OKernel/902/MatFiles/2019-11-14.mat'...
                    '/Users/Shared/Data/OKernel/902/MatFiles/2019-11-15.mat'...
                    '/Users/Shared/Data/OKernel/902/MatFiles/2019-11-18.mat'...
                    '/Users/Shared/Data/OKernel/902/MatFiles/2019-11-19.mat'...
                    '/Users/Shared/Data/OKernel/902/MatFiles/2019-11-20.mat'...
                    '/Users/Shared/Data/OKernel/902/MatFiles/2019-11-21.mat'...
                    '/Users/Shared/Data/OKernel/902/MatFiles/2019-11-22.mat'...
                    '/Users/Shared/Data/OKernel/902/MatFiles/2019-11-25.mat'...
                    '/Users/Shared/Data/OKernel/902/MatFiles/2019-11-26.mat'...
                    '/Users/Shared/Data/OKernel/902/MatFiles/2019-11-27.mat'...
                    '/Users/Shared/Data/OKernel/902/MatFiles/2019-11-30.mat'...
...
                    '/Users/Shared/Data/OKernel/902/MatFiles/2019-12-02.mat'...
                    '/Users/Shared/Data/OKernel/905/MatFiles/2019-09-24.mat'...
                    '/Users/Shared/Data/OKernel/905/MatFiles/2019-10-01.mat'...
                    '/Users/Shared/Data/OKernel/905/MatFiles/2019-10-07.mat'...
                    '/Users/Shared/Data/OKernel/905/MatFiles/2019-10-08.mat'...
                    '/Users/Shared/Data/OKernel/905/MatFiles/2019-10-09.mat'...
                    '/Users/Shared/Data/OKernel/905/MatFiles/2019-10-11.mat'...
                    '/Users/Shared/Data/OKernel/905/MatFiles/2019-10-14.mat'...
                    };
               
%     allSessions = getValidFiles(dataFiles, doRampStim);
    allSessionTypes = getSessions(dataFiles);
    for s = 1:length(allSessionTypes)
        h = figure(s);
        set(h, 'Units', 'inches', 'Position', [20, 5, 8.5, 11]);
        clf;
        doOneFigure(allSessionTypes{s});
    end
end

function doOneFigure(allSessions)
    numFiles = length(allSessions);
    plotStartMS = -400;
    plotEndMS = 400;
    plotRTStartMS = -600;
    plotRTEndMS = 200;
...
%         load(dataFiles{f});                                         % load the session
        file = allSessions(f).file;
        trials = allSessions(f).trials;
        animals{f} = allSessions(f).animal;
    ...
    headerText = cell(1, 1);
    if trials(1).trial.visualRampDurMS > 0
        stepString = 'Ramping Gabor';
    else
        stepString = 'Stepped Gabor';
    end
    headerText{1} = sprintf('%s onset', stepString);
    headerText{length(headerText) + 1} = sprintf('%d sessions from %d animals', numFiles, length(unique(animals)));
...
%%
% function allSessions = getValidFiles(dataFiles, doRampStim)
% % Read in all the data files, eliminate the ones we don't want, and create a data structure for analysis to use
%     numFiles = length(dataFiles);
%     c = cell(1, numFiles);
%     allSessions = struct('animal', c, 'date', c, 'file', c, 'trials', c);
%     validIndices = false(1, numFiles);
%     for f = 1:numFiles
%         pathParts = split(dataFiles{f}, '/');
%         allSessions(f).animal = pathParts{6};
%         allSessions(f).date = pathParts{8};
%         fprintf('%s %s', allSessions(f).animal, allSessions(f).date);
%         load(dataFiles{f});                                         % load the session
%         allSessions(f).file = file;
%         allSessions(f).trials = trials;
%         validIndices(f) = xor(doRampStim, trials(1).trial.visualRampDurMS == 0);
%         if validIndices(f)
%             fprintf(' valid');
%         end
%         fprintf('\n');
%     end
% 	allSessions = allSessions(validIndices);
%     fprintf('%d valid\n', length(allSessions));
% end

%%
function allSessionTypes = getSessions(dataFiles)
% Read in all the data files, sorting them into those with and without ramping stimuli
    numFiles = length(dataFiles);
    c = cell(1, numFiles);
    allSessions = struct('animal', c, 'date', c, 'file', c, 'trials', c);
    noRampIndices = false(1, numFiles);
    rampIndices = false(1, numFiles);
    for f = 1:numFiles
        pathParts = split(dataFiles{f}, '/');
        allSessions(f).animal = pathParts{6};
        dateParts = split(pathParts{8}, '.');
        allSessions(f).date = dateParts{1};
        fprintf('%s %s', allSessions(f).animal, allSessions(f).date);
        load(dataFiles{f});                                         % load the session
        allSessions(f).file = file;
        allSessions(f).trials = trials;
        rampIndices(f) = trials(1).trial.visualRampDurMS > 0;
        noRampIndices(f) = ~rampIndices(f);
        if rampIndices(f)
            fprintf(' ramp');
        end
        fprintf('\n');
    end
    allSessionTypes = {allSessions(noRampIndices); allSessions(rampIndices)};
    allSessionTypes(~cellfun('isempty', allSessionTypes));          % remove empty sets 
end
